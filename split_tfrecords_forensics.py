...
def split_tfrecord(cfg, logger):
    ...
    forensics_train_size = 300000

    part_size = forensics_train_size // cfg.DATASET.PART_COUNT
...
def run():
    parser = argparse.ArgumentParser(description="ALAE. Split forensics into parts for training and testing")
    parser.add_argument(
        "--config-file",
        default="configs/forensics.yaml",
        metavar="FILE",
